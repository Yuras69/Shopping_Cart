 ...
 async function ProductEdit(name,price,quantity) {
    ...
    return (
        <>
            ...
            <div className="p-50">
                ...
                <button onClick={handleChange} className="w-full bg-blue-500 text-white px-4 py-2 rounded-md gap-9">Save Change</button>
